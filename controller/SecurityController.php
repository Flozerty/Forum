...
class SecurityController extends AbstractController
{
  ...
  public function register()
  {
    ...
    if (isset($_POST["submit"])) {
      ...
      $passwordPattern = '/^(?=.*[A-Z])(?=.*\d)[A-Za-z\d]{8,}$/'; // 8 caractères, une majuscule, un chiffre
      if (!preg_match($passwordPattern, $pass1)) {
        $message = "<p class='alertNotif'>Le mot de passe doit contenir au moins 8 caractères, une majuscule et un chiffre.</p>";
        return redirectAndMessage($message);
      }
