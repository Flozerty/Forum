...
INSERT INTO `post` (`id_post`, `postDate`, `messageContent`, `deleted`, `topic_id`, `user_id`) VALUES
	(1, '2024-04-17 12:21:11', 'Bonjour, j\'essaye de faire une omelette à l\'oignon mais j\'arrive pas a casser mes oeufs, quelqu\'un peut m\'aider?', 0, 1, 2),
...
INSERT INTO `topic` (`id_topic`, `title`, `creationDate`, `intro`, `closed`, `category_id`, `user_id`) VALUES
	(1, 'omelette à l\'oignon', '2024-04-17 00:00:00', 'j\'ai besoin d\'aide', 0, 3, 2),
...
INSERT INTO `user` (`id_user`, `pseudo`, `email`, `password`, `dateInscription`, `role`, `avatar`) VALUES
	(1, 'flozerty', 'floris.louerat@gmail.com', '12345azerty', '2024-04-19 00:00:00', 'admin', NULL),
	(2, 'bob', 'bob.bob@bob.bob', 'bobobobobo', '2024-04-19 00:00:00', NULL, NULL),
	(3, 'test', 'test@gmail.com', 'test123', '2024-04-19 00:00:00', NULL, NULL),
	(6, 'arklane', 'arklane.gmail.com', 'arklemochedu73', '2024-04-19 00:00:00', 'modo', NULL);
